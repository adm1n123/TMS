	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		s=fob.head(id)+fob.navbarAdmin(ses)+
				"<div class=\"container\" id=\"bodycontainer\">"+
							"<p class=pageheading>Delete user</p></br>"+
							"<table>"+
								"<tr>"+
									"<td class=entity>User Id </td><td><input type=text id=userid onkeyup=checkIdExist();> <span id=useridspan></span></td>"+
								"</tr>"+
								"<tr><td></br></td><td></br></td></tr>"+
								"<tr>"+
									"<td></td><td  style=\"padding-left:100px;\"><button class=deletebutton disabled=true id=deletebutton onclick=deleteUser();>Delete</button></td>"+
								"</tr>"+
							"</table>"+
						"</div>"+
						fob.footer()+
